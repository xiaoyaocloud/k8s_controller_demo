...
import (
	...
	samplecrdv1 "custom-controller/pkg/apis/samplecrd/v1"
	clientset "custom-controller/pkg/generated/clientset/versioned"
	networkscheme "custom-controller/pkg/generated/clientset/versioned/scheme"
	informers "custom-controller/pkg/generated/informers/externalversions/samplecrd/v1"
	listers "custom-controller/pkg/generated/listers/samplecrd/v1"
)
...
func (c *Controller) syncHandler(key string) error {
	...
	//	glog.Infof("[Neutron] start create netWork")
	 //} else if !reflect.DeepEqual(actualNetwork, network) {
	//	glog.Infof("[Neutron] update netWork")
